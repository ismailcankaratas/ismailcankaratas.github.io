...
const data = [
  {
    ...
    title: "Dbcopycat",
    description:
      "Json verilerinizi bir dosyaya kaydeden ve CRUD işlemlerini gerçekleştirmenizi kolaylaştıran bir JSON Veritabanı.",
  ...
  },
  {
    id: 2,
    image:
      "https://repository-images.githubusercontent.com/539013996/25dd0874-2203-4686-90fc-bc7be9ccb894",
    title: "Contrib Chat",
    description:
      "Github hesabıyla giriş yaparak. GitHub'da katkıda bulunduğunuz repolarda katkıda bulunanlarla sohbet edebilirsiniz.",
